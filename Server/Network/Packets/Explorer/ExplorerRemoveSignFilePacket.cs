...
{
    [ServerPacket(Basic.ServerPackets.ExplorerRemoveSignFile)]
    internal class ExplorerRemoveSignFilePacket : IPacket<NetworkClient>
    {
        ...
        {
            client.Network.Send((byte)ClientPackets.ExplorerRemoveSignFileResult, (byte)result);
        }
    }
}
