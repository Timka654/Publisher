...
{
    [ServerPacket(Basic.ServerPackets.ExplorerPathRemove)]
    internal class ExplorerPathRemovePacket : IPacket<NetworkClient>
    {
        ...
        {
            client.Network.Send((byte)ClientPackets.ExplorerPathRemoveResult, (byte)result);
        }
    }
}
