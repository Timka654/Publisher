...
{
    [ServerPacket(Basic.ServerPackets.ExplorerGetFileList)]
    internal class ExplorerGetFileListPacket : IPacket<NetworkClient>
    {
        ...
        {
            client.Network.Send((byte)ClientPackets.ExplorerGetFileListResult, (byte)result);
        }
    }
}
