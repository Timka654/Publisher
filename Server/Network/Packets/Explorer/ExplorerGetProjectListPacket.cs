...
{
    [ServerPacket(Basic.ServerPackets.ExplorerGetProjectList)]
    internal class ExplorerGetProjectListPacket : IPacket<NetworkClient>
    {
        ...
        {
            client.Network.Send((byte)ClientPackets.ExplorerGetProjectListResult, (byte)result);
        }
    }
}
